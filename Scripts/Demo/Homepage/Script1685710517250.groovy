...
WebUI.click(findTestObject('Page_OrangeHRM/a_Performance'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Admin'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Maintenance'))

WebUI.waitForElementVisible(findTestObject('Page_OrangeHRM/h6_Administrator Access'), 0)
